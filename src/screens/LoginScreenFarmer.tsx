...
const LoginScreenFarmer: React.FC<LoginScreenProps> = ({ navigation }) => {
  ...
  const handleLogin = async () => {
    ...
    // Simulate API call
    const res = await axios.post("http://localhost:8000/api/v1/farmer/login", {
      email,
      password,
    });
    const data = res.data;
...
export default LoginScreenFarmer;
